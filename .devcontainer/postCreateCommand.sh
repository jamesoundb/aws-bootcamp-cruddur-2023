...
#Generate Envs
bash /workspaces/aws-bootcamp-cruddur-2023/bin/backend/generate-env-codespaces && bash /workspaces/aws-bootcamp-cruddur-2023/bin/frontend/generate-env-codespaces
